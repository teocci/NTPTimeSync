...
{
    private static final String TAG = LogHelper.makeLogTag(NtpMessage.class);
     ...
     * LOCL     uncalibrated local clock used as a primary reference for a subnet
     * .        without external means of synchronization
     * PPS      atomic clock or other pulse-per-second source individually
